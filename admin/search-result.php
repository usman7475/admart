...
<h1 class="mt-4">Search Result Against "<?php echo $searchdata; ?>"</h1>
...
<?php 
$userid = $_SESSION["edmsid"];
$query = mysqli_query($con, "SELECT * FROM customer WHERE name LIKE '%$searchdata%' OR phone LIKE '%$searchdata%' OR email LIKE '%$searchdata%'");
$cnt = 1;
