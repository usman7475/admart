...
mysqli_query($con, "DELETE FROM customer WHERE id='$nid'");
...
<td>
<a href="manage-notes.php?id=<?php echo $row['id']; ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-sm">Delete</a>
</td>
</tr>
<?php 
$cnt++; 
