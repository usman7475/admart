...
mysqli_query($con, "DELETE FROM enquiries WHERE id='$nid'");
...
<?php 
$userid = $_SESSION["edmsid"];
$query = mysqli_query($con, "SELECT * FROM enquiries");
$cnt = 1;
...
<td><?php echo htmlentities($row['enquiry_type']); ?></td>
<td><?php echo htmlentities($row['enquiry']); ?></td>
<td>
<a href="messages.php?id=<?php echo $row['id']; ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-sm">Delete</a>
</td>
</tr>
<?php 
$cnt++; 
