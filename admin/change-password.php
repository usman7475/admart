                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <form method="post" name="chngpwd" onSubmit="return valid();">
                                    <div class="row mb-3">
                                        <label for="cpass" class="col-md-2 col-form-label">Current Password</label>
                                        <div class="col-md-6">
                                            <input type="password" class="form-control" id="cpass" name="cpass" required="required">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="newpass" class="col-md-2 col-form-label">New Password</label>
                                        <div class="col-md-6">
                                            <input type="password" class="form-control" id="newpass" name="newpass" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="cnfpass" class="col-md-2 col-form-label">Confirm Password</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 text-center">
                                            <input type="submit" style="float: right;" name="update" id="update" class="btn btn-primary" value="Change">
                                        </div>
                                    </div>
                                </form>
                            </div>
